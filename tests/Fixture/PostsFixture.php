...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_url' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'fk_posts_category_idx' => ['type' => 'index', 'columns' => ['category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'slug_UNIQUE' => ['type' => 'unique', 'columns' => ['slug'], 'length' => []],
            'fk_posts_category' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'fk_posts_user' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created_at' => '2019-03-05 00:14:51',
                'updated_at' => '2019-03-05 00:14:51',
                'published_at' => '2019-03-05 00:14:51',
                'user_id' => 1,
                'category_id' => 1
            ],
        ];
